...
def test_deterministic():
    with open(f"{hw_path}/deterministic_results.pkl", 'rb') as f:
        deterministic_results: list[bool] = pickle.load(f)
...
def test_pushed():
    with open(f"{hw_path}/pushed_fsas.pkl", 'rb') as f:
        pushed_fsas: list[FSA] = pickle.load(f)
    with open(f"{hw_path}/pushed_results.pkl", 'rb') as f:
        pushed_results: list[bool] = pickle.load(f)
...
def test_reverse():
    ...
    with open(f"{hw_path}/reversed_fsas.pkl", 'rb') as f:
        reversed_fsas: list[FSA] = pickle.load(f)
...
def test_accessible():
    ...
    with open(f"{hw_path}/accessible_states.pkl", 'rb') as f:
        accessible_states_fsas: list[set] = pickle.load(f)
...
def test_coaccessible():
    ...
    with open(f"{hw_path}/coaccessible_states.pkl", 'rb') as f:
        coaccessible_states_fsas: list[set] = pickle.load(f)
...
def test_union():
    with open(f"{hw_path}/union_fsas.pkl", 'rb') as f:
        union_fsas: list[FSA] = pickle.load(f)
...
def test_concatenate():
    with open(f"{hw_path}/concat_fsas.pkl", 'rb') as f:
        concat_fsas: list[FSA] = pickle.load(f)
...
def test_closure():
    with open(f"{hw_path}/kleene_fsas.pkl", 'rb') as f:
        kleene_fsas: list[(FSA, FSA)] = pickle.load(f)
    
    for fsa, kleene in kleene_fsas:
